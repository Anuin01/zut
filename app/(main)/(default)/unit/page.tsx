    ...
    const renderHeader1 = () => {
        return (
            <div className="flex justify-content-between">
                <Button type="button" icon="pi pi-plus" label="Шинээр үүсгэх" outlined onClick={clearFilter1} />
                <span className="p-input-icon-left">
                    <i className="pi pi-search" />
                    <InputText value={globalFilterValue1} onChange={onGlobalFilterChange1} placeholder="Хайх..." />
                </span>
            </div>
        );
    };
    ...
    return (
        <div className="grid">
            <div className="col-12">
                <div className="card">
                    <h5>Өгөгдөл, лавлагаа: Засварын цех, тасгийн бүртгэл, мэдээлэл</h5>
                    <DataTable
                        value={customers1}
                        paginator
                        ...
                        header={header1}
                    >
                        <Column field="name" header="Бүртгэлийн дугаар" filter filterPlaceholder="Search by name" style={{ minWidth: '12rem' }} />
                        <Column
                            header="Харъяалагдах хэсэг, нэгж"
                        ...
                        />
                        <Column header="Цехийн товч нэр" filterField="date" dataType="date" style={{ minWidth: '10rem' }} body={dateBodyTemplate} filter filterElement={dateFilterTemplate} />
                        <Column header="Цехийн мастерийн нэр" filterField="balance" dataType="numeric" style={{ minWidth: '10rem' }} body={balanceBodyTemplate} filter filterElement={balanceFilterTemplate} />
                        <Column field="status" header="Ажлын явц,гүйцэтгэл харуулах эсэх" filterMenuStyle={{ width: '14rem' }} style={{ minWidth: '12rem' }} body={statusBodyTemplate} filter filterElement={statusFilterTemplate} />
                        <Column field="activity" header="Утас" showFilterMatchModes={false} style={{ minWidth: '12rem' }} body={activityBodyTemplate} filter filterElement={activityFilterTemplate} />
                        <Column field="activity" header="И-майл хаяг" showFilterMatchModes={false} style={{ minWidth: '12rem' }} body={activityBodyTemplate} filter filterElement={activityFilterTemplate} />
                        <Column field="activity" header="Гэрийн хаяг" showFilterMatchModes={false} style={{ minWidth: '12rem' }} body={activityBodyTemplate} filter filterElement={activityFilterTemplate} />
                        <Column field="activity" header="Тайлбар" showFilterMatchModes={false} style={{ minWidth: '12rem' }} body={activityBodyTemplate} filter filterElement={activityFilterTemplate} />
                        <Column field="verified" header="Засах" dataType="boolean" bodyClassName="text-center" style={{ minWidth: '8rem' }} body={verifiedBodyTemplate} filter filterElement={verifiedFilterTemplate} />
                    </DataTable>
                </div>
            </div>
